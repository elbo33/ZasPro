...
FORMULA_ROWS: dict[str, dict[str, object]] = {
    ...
    "V.R3": {
        "name": "dowodzi monotoniczności funkcji zadanej wzorem, jak w podanym przykładzie",
        "statement_latex": r"\text{wykaż, że } f(x)=\frac{x-1}{x+2} \text{ jest monotoniczna w przedziale } (-\infty,\,-2)",
    ...
    "VI.R1": {
        "name": "oblicza granice ciągów, korzystając z granic ciągów wzorcowych oraz twierdzeń o granicy sumy, różnicy, iloczynu i ilorazu ciągów zbieżnych, a także twierdzenia o trzech ciągach",
        "statement_latex": r"\text{typu } \tfrac{1}{n}, \; \sqrt[n]{a}",
